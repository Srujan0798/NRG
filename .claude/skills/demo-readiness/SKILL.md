# Demo Readiness — The Professor Test

> **Trigger:** Before any demo, UI sprint completion, or frontend release.  
> **Purpose:** Ensure the product looks and feels like a ₹50L sovereign platform, not a hackathon prototype.  
...
- When the founder says "is this demo-ready?"
...
Before claiming any frontend task DONE, walk through the 10-step demo script.

---

## Quick Checklist (5 Minutes)

Run these in order. Any FAIL = stop and fix before demo.
...
10. **Demo Script** — Walk through the exact 10-step professor sequence
...
Before claiming demo-ready, produce:

1. **Screen recording** of the 10-step demo script (Section 10 of ux_audit_protocol.md)
...
> A backend agent can claim DONE with passing tests. A frontend agent cannot claim DONE without walking through the demo script in a real browser. The professor sees UI. Not tests.
