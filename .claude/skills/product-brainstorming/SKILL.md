...
- **Inversion**: "How could we make this problem worse? Now reverse each of those."
...
- Suggested next steps (research, build a production module, talk to users, write a one-pager)
