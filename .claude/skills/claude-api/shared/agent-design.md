...
| **Code execution** | Server | Claude needs to run code in a isolated environment you don't want to manage. | Anthropic-hosted container with built-in file and bash sub-tools. No client-side execution. |
