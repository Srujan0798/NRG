...
3. Frontend polls `/api/tasks/<uuid>` every 1-2s OR receives `/ws/tasks/<uuid>` WebSocket events. Mid-computation transparency (`ux_audit_protocol.md` §11.5 / §12) updates the user during the wait.
