...
- **Produce Known State Table**: explicit WORKING vs BROKEN list before any new work. Agents must not re-break what's working. See `.claude/rules/audit/protocol.md` Section 4 for the D1-D10 checklist template.
