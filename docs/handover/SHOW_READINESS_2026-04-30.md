...
Status: locally show-ready with explicit external blockers
...
Do not present this as full sovereign-cluster production readiness. The strict C4 load target and live deployed replay still need a running deployment/cluster.

## 90-Second Walkthrough

1. Open the app at the login screen.
   - Evidence: `evidence/2026-04-30/ui_ux/after/login_1366.png`
   - Mobile: `evidence/2026-04-30/ui_ux/after/login_375.png`
...
2. Login as Tier 1 researcher.
   ...
   - Evidence: `evidence/2026-04-30/ui_ux/after/dashboard_researcher_1366.png`

3. Ask a messy-but-valid query.
   - Recommended: `best quantum researchers`
   - Expected behavior: the system extracts the research intent, retrieves bounded researcher/institution evidence, and returns a source-backed answer or a clarification when ranking evidence is unavailable.
   - Backend evidence: `evidence/2026-04-30/wave1_messy_query_acceptance.md`

4. Show streaming phases.
   - Planning, retrieval, synthesis, verification.
   - Evidence: `evidence/2026-04-30/ui_ux/after/answer_streaming_1366.png`
   - Mobile: `evidence/2026-04-30/ui_ux/after/answer_streaming_375.png`

5. Show the final answer.
   - Point to confidence, citations, source data, SQL/proof drawer, audit ID, and copy action.
   - Evidence: `evidence/2026-04-30/ui_ux/after/answer_final_1366.png`
   - Mobile: `evidence/2026-04-30/ui_ux/after/answer_final_375.png`

6. Open source/citation/audit proof.
   - Show that the answer has citations and an audit event ID.
   - Raw Tier 1 JSON: `evidence/2026-04-30/09_tier1_query_response.json`
   - Audit evidence: `evidence/2026-04-30/wave3_security_tier_audit_acceptance.md`
...
8. Ask a blocked sensitive request.
   ...
   - Evidence: `evidence/2026-04-30/wave3_blocked_query_responses.json`

9. Open audit view.
   - Show audit list and proof language.
   - Screenshot: `evidence/2026-04-30/ui_ux/after/audit_list_1366.png`
   - Final audit verification: `scripts/audit_investigate.py` returned `ok=true`, `events_checked=38383`.
...
| Live deployed browser replay | Not rerun after Wave 5 | Start backend/frontend together and repeat the Wave 2 Playwright/browser path without mocks. |
...
If network or backend fails during the show, use the screenshots under `evidence/2026-04-30/ui_ux/after/` and the raw JSON files in `evidence/2026-04-30/` to demonstrate the verified path.
