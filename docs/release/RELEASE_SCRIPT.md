# NRG 12-Minute Demo Script

Date: 2026-04-26
Recording target: `evidence/2026-04-26/demo_rehearsal.mp4`
...
4. Record a single continuous browser video.

## Timed Script And Transcript

| Time | Screen | Action | Spoken Transcript |
|---:|---|---|---|
| 00:00 | Login | Open NRG in a clean browser. | "This is the exact professor flow from a clean session. The first screen is NRG, the National Research Graph." |
...
| 02:00 | Query Box | Submit: `Which institutes in India have the highest grant amount in renewable energy?` | "This is the core demo question: a professor asks a funding question in plain English." |
...
| 07:00 | Persona Switch | Use persona toggle to switch from Researcher to Industry. | "Now I switch personas in the room so the professor can see the product enforce tiered access." |
...
| 10:00 | Switch Back | Switch back to Researcher. | "I switch back to the researcher persona to show the audit trail created during the rehearsal." |
...
| 11:45 | Close | Pause on the working dashboard. | "The demo ends with the product still in a healthy, navigable state." |
