#!/usr/bin/env python3
"""
NRG 10-Step Acceptance Verification Script.
Runs through the complete stakeholder acceptance session and verifies every step.

Usage:
    python scripts/run_acceptance_verification.py

Outputs:
    - Console pass/fail for each step
    - Screenshots in evidence/2026-04-27/acceptance_verification/
"""
...
EVIDENCE_DIR = Path("evidence/2026-04-27/acceptance_verification")
...
def run_acceptance():
    ...
    if fails == 0:
        print("🎯 Acceptance is 10/10 confirmed!")
        return 0
    else:
