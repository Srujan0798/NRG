...
ALLOWLIST_PATHS='\.claude/rules/production_only\.md|\.claude/memory/|docs/specs/MASTER_EXECUTION_PLAN_|docs/task_protocols/PRODUCTION_READINESS_MASTER\.md|scripts/forbidden_vocab_check\.sh|protocols/[0-9]+_LB[0-9]+_|^BACKLOG\.md$'
