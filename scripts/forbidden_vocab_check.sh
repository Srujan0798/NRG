...
ALLOWLIST_PATHS='\.claude/rules/production_only\.md|docs/specs/MASTER_EXECUTION_PLAN_|docs/task_protocols/PRODUCTION_READINESS_MASTER\.md|scripts/forbidden_vocab_check\.sh'
