...
DHAIRYA_CASES = [
    ...
    ("Q05", "Percentage of IIT Madras innovations stuck at Lab Validation Level 4.", "SELECT stage_of_technology, COUNT(*) FROM innovations_at_various_stages_of_technology_readiness_level GROUP BY stage_of_technology", [{"stage_of_technology": "Level 4", "count": 10}], "aggregate_collapse"),
    ("Q06", "List Market Ready TRL 9 technologies for IIT Madras.", "SELECT * FROM innovations_at_various_stages_of_technology_readiness_level WHERE stage_of_technology = 'TRL 9'", [], "row_count_zero"),
