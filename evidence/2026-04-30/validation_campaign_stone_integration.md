...
NRG hybrid prompt system without converting NRG into a generic app or copying
impossible claims.
...
- Generic app framing that does not fit NRG's sovereign research answer-engine
  workflow.
...
Result: no unsafe copied external-prompt framing remains in active prompt stones.
