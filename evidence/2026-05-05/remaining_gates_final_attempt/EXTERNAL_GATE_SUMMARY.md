...
|---|---:|---|
| current_local_c4_scorecard | FAIL live / PASS local regression | `scripts/quality_bar_scorecard.json` is 5/6. C1, C2, C3, C5, and C6 pass. C4 local regression passed 9/9, but the available forwarded live target failed 1000-user C4 with P99 4900 ms and 0.1717% failures (`evidence/2026-05-06/runtime_recovery/live_c4_locust_failure_summary.md`). |
...
quality-bar evidence is partial and available live C4 evidence failed. Deployed
